...
<?php include_once("../includes/printhead.php"); ?>
      ...
      <div id="content">
        ...
        <div class="spalte3" style="margin-top: 20px;">
          ...
          <p style="margin-top:20px;"><strong>Rolf Glunz</strong> ist Leiter des Vertriebs bei imbus. Mit mehr als 15-jähriger Erfahrung in Professional Services Organisationen (u.a. bei Oracle Deutschland und IHS-Technologies) gilt sein Interesse dem Erfolg des Kunden beim Einsatz von Dienstleistungen und Produkten in Qualitätsmanagement und Test von Software.</p>
        </div>
      </div>
