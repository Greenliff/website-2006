...
<?php include_once("../includes/printhead.php"); ?>
			...
			<div id="scrollcontent" class="events">
				<div class="startspalte">
					...
					<h3>Bookings</h3>
<?php
					if(isset($meldung) && $meldung != '') { echo $meldung; }
?>
						<div class="div1">
							<span class="formlabel">Price</span>CHF 190</span>
						</div>
						<div class="div1">
							<span class="formlabel required<?php if($fehler && $lastname == "") echo " marker"; ?>">Last name</span>
							<input type="text" name="lastname"<?php echo $readonly; ?> class="formfeld" value="<?php echo $lastname; ?>" />
						</div>
						<div class="div1">
							<span class="formlabel required<?php if($fehler && $firstname == "") echo " marker"; ?>">First name</span>
							<input type="text" name="firstname"<?php echo $readonly; ?> class="formfeld" value="<?php echo $firstname; ?>" />
						</div>
						<div class="div1">
							<span class="formlabel required<?php if($fehler && $company == "") echo " marker"; ?>">Company</span>
							<input type="text" name="company"<?php echo $readonly; ?> class="formfeld" value="<?php echo $company; ?>" />
						</div>
						<div class="div1">
							<span class="formlabel">Department</span>
							<input type="text" name="department"<?php echo $readonly; ?> class="formfeld" value="<?php echo $department; ?>" />
						</div>
						<div class="div1">
							<span class="formlabel required<?php if($fehler && $phone == "") echo " marker"; ?>">Phone</span>
							<input type="text" name="phone"<?php echo $readonly; ?> class="formfeld" value="<?php echo $phone; ?>" />
						</div>
						<div class="div1">
							<span class="formlabel">Fax</span>
							<input type="text" name="fax"<?php echo $readonly; ?> class="formfeld" value="<?php echo $fax; ?>" />
						</div>
						<div class="div1">
							<span class="formlabel required<?php if($fehler && $e_mail == "") echo " marker"; ?>">Email</span>
							<input type="text" name="e_mail"<?php echo $readonly; ?> class="formfeld" value="<?php echo $e_mail; ?>" />
						</div>
						<div class="div1">
							<span class="formlabel required<?php if($fehler && $street == "") echo " marker"; ?>">Street</span>
							<input type="text" name="street"<?php echo $readonly; ?> class="formfeld" value="<?php echo $street; ?>" />
						</div>
						<div class="div1">
							<span class="formlabel required<?php if($fehler && $zip == "") echo " marker"; ?>">Zip-Code</span>
							<input type="text" name="zip"<?php echo $readonly; ?> class="formfeldkurz" value="<?php echo $zip; ?>" />
						</div>
						<div class="div1">
							<span class="formlabel required<?php if($fehler && $city == "") echo " marker"; ?>">City</span>
							<input type="text" name="city"<?php echo $readonly; ?> class="formfeld" value="<?php echo $city; ?>" />
						</div>
						<div class="div1" style="margin-top: 30px;">
							<span class="formlabel">Comment</span>
							<textarea name="comment"<?php echo $readonly; ?> class="textarea" style="height:60px;"><?php echo $comment; ?></textarea>
						</div>
<?php
if(!$success)
{
