...
if(isset($_POST['send']))
{
  ...
  else
  {
    ...
    $betreff = "Anmeldung 20. November 2012: Agile Software-Projekte";
    $text = "\n\n";
    $text .= 'Anmeldung für den Anlass "Brauchen Agile Software-Projekte eine Prozessverbesserung?" vom 20. November 2012' . ":\n\n";
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  <head>
    ...
    <title>Greenliff: Brauchen Agile Software-Projekte eine Prozessverbesserung? - Anmeldung</title>
      ...
      <div id="scrollcontent" class="events">
        <div class="startspalte">
          ...
          <form method="post" action="<?php echo $datei; ?>.php" style="margin-top: 30px;">
            ...
            <div class="div1">
              <span class="formlabel">Abteilung/Funktion</span><input type="text" name="department"<?php echo $readonly; ?> class="formfeld" value="<?php echo $department; ?>" />
            </div>
            <div class="div1">
...
?>
        <div class="news">
          ...
          <p><a href="../docs/Agile_Software_Qualitaetsverbesserung_14092012.pdf" target="_blank">Veranstaltungsflyer</a> (pdf)</p>
