...
<?php include_once("../includes/printhead.php"); ?>
      ...
      <div id="scrollcontent" class="home">
        ...
        <div class="event" style="margin-top:10px;">
          <div class="spalte1">
            <a href="#" target="_blank"><img src="../images/events/trends_in_testing.gif" alt="Logo Internet Briefing" width="150" height="75" /></a>
          </div>

          <div class="spalte2Breit">
            <h2>Zürich, 27. September 2011</h2>
              <h3 style="padding-top: 11px;">Testautomatisierung out-of-the-box!</h3>
              ...
              <p>Die Veranstaltung ist kostenfrei und beginnt um 12:30 Uhr.</p>
              <p>Die ausführliche <a href="../docs/110927_TrendsinTestingZuerich.pdf">Programmbeschreibung und Ihr Anmeldeformular</a> finden Sie im Veranstaltungsflyer</p>
          </div>
        </div>
