...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  <head>    
    ...
    <title>Greenliff: Test Engineer</title>
...
<?php include_once("../../includes/printhead.php"); ?>
      ...
      <div id="content" class="home">
        <div class="spalte1">
          <h3>Test Engineer</h3>
          <p>Greenliff is a small, dynamic and growing company specializing in software testing. We are currently seeking  Test Engineers at our  Zurich Technopark  office.</p>
          ...
          <h3>We offer:</h3>
          <ul>
            <li>Exciting work in interesting projects in small teams</li>
        ...
        <div class="spalte2">
          ...
          <ul>
            ...
            <li>ideally some experience in the testing or testing methodologies</li>
            <li>knowledge of Java, Ruby, C# or other object oriented language</li>
            <li>knowledge in scripting</li>
            <li>knowledge of some test tools, e. g. Mercury or test director an asset</li>
