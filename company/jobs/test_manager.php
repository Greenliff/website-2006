...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  <head>    
    ...
    <title>Greenliff: Test Manager</title>
...
<?php include_once("../../includes/printhead.php"); ?>
      ...
      <div id="content" class="home">
        <div class="spalte1">
          <h3>Test Manager</h3>
          <p>Greenliff is a small, dynamic and growing company specializing in software testing. We are currently seeking  Test Managers at our  Zurich Technopark  office.</p>
        ...
        <div class="spalte2">
          ...
          <ul>
            ...
            <li>good knowledge of test processes</li>
            <li>experience in implementing whole test processes</li>
            <li>knowledge of test tools, e. g. Mercury or test director</li>
