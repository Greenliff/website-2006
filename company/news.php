...
<?php include_once("../includes/printhead.php"); ?>
      ...
      <div id="content">
        <div class="spalte1">
			...
			05.11.2012<br /><br />
			<p> 
				<a href="http://www.pass.ch/" target="_blank">PASS Technologies</a> and <a href="/index.php">Greenliff</a> have stepped into a strategic partnership to extend their portfolio of QA and testing services.
			...
			<p> 
				...
				<a href="../partners/index.php">Partner</a><br />
			</p> 
       </div>
         <div class="spalte2">
			<p> 
				<a href="http://www.pass.ch/" target="_blank">PASS Technologies</a> und <a href="/index.php">Greenliff</a> sind eine strategische Partnerschaft eingegangen, um bestehenden und neuen Kunden eine erweiterte 
