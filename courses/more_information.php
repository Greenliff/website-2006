...
if(isset($_POST["send"]))
{
  ...
  if(isset($_POST["CertifiedTester"]) && $_POST["CertifiedTester"] == "CertifiedTester")
  {
    $information .= "* ISTQB&#174; Certified Tester\n";
    $checked2 = ' checked="checked"';
  }
  if($other != "")
  {
      ...
      <div id="content" class="courses">
        <div class="startspalte">
          ...
          <form name="interest" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
            ...
            <div class="div3">
              <input type="checkbox" name="CertifiedTester"<?php echo $readonly; ?> value="CertifiedTester"<?php echo $checked2; ?> />&nbsp;ISTQB&#174; Certified Tester<br />
            </div>
            <div class="div1">
