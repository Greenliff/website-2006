<?
	$title = "imbus AG - specialists for software quality assurance and test";
	$desc = "imbus AG is one of Germany's leading specialists for software quality assurance and test. Sukha IT developed an test automation framework for iOS apps.";
