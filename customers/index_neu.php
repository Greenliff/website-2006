...
<?php include_once("../includes/printhead.php"); ?>
      ...
      <div id="content" class="customers">
        ...
        <div class="spalte1">
          ...
          <div class="center" style="width: 160px;">
            <a href="http://www.avanon.com/" target="_blank" class="customerlogo"><img src="../images/customers/avanon_logo.gif" alt="Avanon AG" width="160" height="38" /></a>
          </div>
          
          <div class="center" style="width: 160px;">
            <a href="http://www.swx.ch" target="_blank" class="customerlogo"><img src="../images/customers/swx_logo_neu.gif" alt="SWX Swiss Exchange" width="160" height="15" /></a>
          </div>
        </div>
        ...
        <div class="spalte2">
          ...
          <div class="center" style="width: 129px;">
            <a href="http://www.myriadgroup.com/" target="_blank" class="customerlogo" style="margin-top:30px;"><img src="../images/customers/Myriad.jpg" alt="Myriad" width="129" height="60" /></a>
          </div>
          ...
          <div class="center" style="width: 180px;">
            <a href="http://www.surfkitchen.com/" target="_blank" class="customerlogo"><img src="../images/customers/surfkitchen_logo.gif" width="180" height="47" alt="SurfKitchen" /></a>
          </div>
        </div> 
