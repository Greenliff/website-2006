...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  <head>    
    ...
    <title>Greenliff: Test Case and Tool Development</title> 
...
<?php include_once("../includes/printhead.php"); ?>
      ...
      <div id="content" class="portfolio">
       ...
       <h3>Information Request</h3>
          <p>Please use our <a href="more_information.php?infos=TestDevelopment">online request form</a> to submit your inquiry.</p>
        </div>
      </div>
